...
if __name__ == '__main__':
    ...
    wall = Line(Point(1, 2), Point(1, 4))
    wall.draw(WindowSingleton()())

    wall2 = Line(Point(2, 2), Point(2, 4))
    wall2.draw(WindowSingleton()())

    wall3 = Line(Point(1, 2), Point(2, 2))
    wall3.draw(WindowSingleton()())
